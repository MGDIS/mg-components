...
- Upgrade to Stencil v3
- [**`<mg-pagination>`**](./?path=/docs/atoms-mg-pagination--mg-pagination) Add prop `hideNavigationLabels` to hide "next/previous" labels in navigation.
- [**`<mg-form>`**](./?path=/docs/atoms-mg-form--mg-form) Update required message when single.
