...
- [**`<mg-popover>`**](./?path=/docs/molecules-mg-popover--mg-popover) enable close button when disabled
...
- [#180](https://gitlab.mgdis.fr/core/core-ui/mg-components/-/issues/180) mg-detail - add possibility to hide button text
...
- [#189](https://gitlab.mgdis.fr/core/core-ui/mg-components/-/issues/189) mg-button - make button take 100% of width
