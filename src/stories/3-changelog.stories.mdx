...
- Added icons to [**`<mg-icon>`**](?path=/docs/atoms-mg-icon--mg-icon), [see all the availables icons](?path=/docs/style-icons--icons).
...
- [#122](https://gitlab.mgdis.fr/core/core-ui/mg-components/-/issues/122) mg-icon: e2e tests
...
- [#141](https://gitlab.mgdis.fr/core/core-ui/mg-components/-/issues/141) mg-tabs - use shadow dom
