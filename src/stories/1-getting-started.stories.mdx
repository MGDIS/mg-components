...
You can have troubles with i18n render in slots. In some cases, with the exemple below, the i18n can not be render due to angularjs lifecycle and i18n filter render hook.
