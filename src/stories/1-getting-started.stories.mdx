...
TODO: update URL at next CORE release
If this syntax is too verbose for you, you can use the directive `v-mg-model` used in the [mg-model directive](http://core.pages.mgdis.fr/core-back/core/docs/), the syntax will become:
...
TODO: update URL at next CORE release
To solve this issue, you need to use the [mg-model directive](http://core.pages.mgdis.fr/core-back/core/docs/) to force the i18n render in slot.
