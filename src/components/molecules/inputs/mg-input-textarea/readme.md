This atom refers to the [PDA9-683](https://jira.mgdis.fr/browse/PDA9-683).
...
| `helpText`              | `help-text`               | Add an help text under the input, usually expected data format and example                                                                     | `string`  | `undefined`                     |
