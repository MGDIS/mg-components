  ...
  render(): HTMLElement {
    ...
    return (
      <MgInput
        ...
        required={!this.readonly && this.required} // required is only used display asterisk
        readonly={undefined}
        mgWidth={undefined}
        ...
        helpText={!this.readonly && this.helpText}
        errorMessage={!this.readonly && this.errorMessage}
        isFieldset={true}
      >
