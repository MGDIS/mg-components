...
const Template = args => {
    ...
    const valuesSideBySide = args.valuesSideBySide;
    delete args.valuesSideBySide;
    // return element
    ...
    help-text={helpText}
    values-side-by-side={valuesSideBySide}
  >
...
const TemplateIcon = args => {
  ...
  return   <mg-input-toggle
    ...
    values-side-by-side={valuesSideBySide}
  >
    <span slot="item-1" class="mg-input_button-toggle__item-container--icon"><mg-icon icon="cross"></mg-icon></span>
    <span slot="item-2" class="mg-input_button-toggle__item-container--icon"><mg-icon icon="success"></mg-icon></span>
  </mg-input-toggle>
};
