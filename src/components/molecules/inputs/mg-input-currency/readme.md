...
| `identifier`         | `identifier`   | Identifier is used for the element ID (id is a reserved prop in Stencil.js) If not set, it will be created.                                    | `string`  | `createID('mg-input-currency')` |
...
```mermaid
graph TD;
  mg-input-currency --> mg-label
  mg-input-currency --> mg-tooltip
  mg-input-currency --> mg-icon
  mg-input-currency --> mg-character-left
  mg-input-currency --> mg-help-text
  style mg-input-currency fill:#f9f,stroke:#333,stroke-width:4px
```
