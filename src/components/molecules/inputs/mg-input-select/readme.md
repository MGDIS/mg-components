...
| `value`                   | `value`                | Component value                                                                                                                                | `string \| { title: string; value: unknown; disabled?: boolean; group?: string; }` | `undefined`       |
...
| `value-change` | Emited event when value change      | `CustomEvent<string \| { title: string; value: unknown; disabled?: boolean; group?: string; }>` |
