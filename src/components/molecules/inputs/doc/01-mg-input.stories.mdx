...
- the field label is displayed in @color-danger
- the frame of the input field is displayed in @color-danger
- an alert message is displayed in @color-danger below the input field
- if an informative "i" follows the field, it is displayed in @color-danger
